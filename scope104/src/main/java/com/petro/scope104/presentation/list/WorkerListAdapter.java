...
public class WorkerListAdapter extends ListAdapter<WorkerEntity, WorkerListAdapter.AbstractViewHolder> {
    ...
    interface OnClickListener {
        void onClick(WorkerEntity clickedItem, List<View> transitionView);
    }

    private static class UserDiffCallBack extends DiffUtil.ItemCallback<WorkerEntity> {

        @Override
        public boolean areItemsTheSame(@NonNull WorkerEntity oldItem, @NonNull WorkerEntity newItem) {
            return oldItem.getUsername().equals(newItem.getUsername());
        }

        @Override
        public boolean areContentsTheSame(@NonNull WorkerEntity oldItem, @NonNull WorkerEntity newItem) {
    ...
    abstract static class AbstractViewHolder extends RecyclerView.ViewHolder{
        ...
        public abstract void bind(WorkerEntity item);
    }
    ...
    static class WorkerViewHolder extends AbstractViewHolder {
        ...
        public void bind(WorkerEntity item) {
